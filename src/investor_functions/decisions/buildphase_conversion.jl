...
function finish_construction!(projects::Vector{<: Project{<: BuildPhase}},
     ...
     if get_construction_year(project) == iteration_year
        ...
        add_device_forecast!(simulation_dir, sys_UC, sys_ED, PSY_project_UC, PSY_project_ED, availability_raw, availability_raw_rt, iteration_year, simulation_years, scenario_names, da_resolution, rt_resolution)
